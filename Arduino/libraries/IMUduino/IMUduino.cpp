...
*/
void IMUduino::getValues(float * values) {  
  
  // MPU6050
    int16_t accgyroval[6];
    // @TODO: Integrate magnetometer readings into getMotion9() and use that instead.
...
void  IMUduino::AHRSupdate(float gx, float gy, float gz, float ax, float ay, float az, float mx, float my, float mz) {
...
*/
float IMUduino::getBaroAlt(float sea_press) {
...
*/
void IMUduino::gravityCompensateAcc(float * acc, float * q) {
  float g[3];
...
*/
void IMUduino::getEulerRad(float * angles) {
...
*/
void IMUduino::getEuler(float * angles) {
  getEulerRad(angles);
 ...
 * angles from Earth and the IMU. For Euler representation Yaw, Pitch and Roll see IMUduino::getEuler
 * 
 * @param ypr three floats array which will be populated by Yaw, Pitch and Roll angles in radians
*/
/*
void IMUduino::getYawPitchRollRad(float * ypr) {
  float q[4]; // quaternion
...
*/
/*
void IMUduino::getYawPitchRoll(float * ypr) {
